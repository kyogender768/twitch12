...
twitch_miner = TwitchChannelPointsMiner(
    username="Dynamo__Live",
    password="9811390878HHeLiBeBCNeOF@pma2@@@",           # If no password will be provided, the script will ask interactively
